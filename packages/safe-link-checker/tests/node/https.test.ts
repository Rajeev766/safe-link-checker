...
// @ts-ignore - TS complains about .ts extension, but Jest ESM resolution requires it here
const { validateHttps } = await import('@safe-link-checker/node-runtime/validators/https.ts');
