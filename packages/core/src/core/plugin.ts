...
import type { VerifyOptions, CheckResult, RedirectAnomalyKind } from '@safe-link-checker/types';
...
export interface VerificationPlugin {
  ...
  /**
   * Optional: Restricts plugin to specific runtimes. Plugins with runtime='node'
   * are skipped in browser/edge environments unless node-like capabilities exist.
   */
